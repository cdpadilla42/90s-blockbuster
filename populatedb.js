...
var Book = require('./models/movie');
var Author = require('./models/director');
var Genre = require('./models/genre');
var BookInstance = require('./models/movieinstance');
...
function bookCreate(title, summary, isbn, director, genre, cb) {
  bookdetail = {
    title: title,
    summary: summary,
    director: director,
